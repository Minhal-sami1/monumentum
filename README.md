# monumentum — the Monumentum standard
...
> **Status: pre-release.** The working name is `monumentum`; the final
> protocol name is not settled. Nothing here has been published.

## Quick look

```bash
monumentum init                     # scaffold .monumentum/, write the AGENTS.md contract
...
monumentum verify .                 # journal chain + managed files, one CI command
```
...
| [spec/monumentum-spec.md](spec/monumentum-spec.md) | The normative specification, v0.1 |
